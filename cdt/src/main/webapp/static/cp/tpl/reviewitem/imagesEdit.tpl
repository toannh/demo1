    ...
    <ul class="thumbnails gallery" id="imageModel">
        ...
        <li  style="float: left; list-style: none; padding: 0px 5px; margin: 0px 5px; height: 100px; width: 100px; margin-bottom: 50px;" for="<%= i %>">
            <a style="cursor:pointer" >
                <img height="100px" width="100px" src="<%= this %>" class="grayscale" title="image <%= i %>" alt="Image<%= i %>">
                <div align="center" title="Xóa ảnh này" onclick="reviewitem.deleteImage('<%= this %>', '<%= i%>')">
    ...
    <form id="image-model" class="form-horizontal" role="form">
        <div class="left">
            ...
            <div class="radio" id="upload1">
                <input type="file" style="display:none" id="lefile" name="image" onchange="reviewitem.addImage();">
            ...
            <div id="upload2" style="display: none;width:300px;"  class="radio">
                <input type="text" class="form-control" name="imageUrl" onchange="reviewitem.addImage();" />               
            </div>
        </div>
    </form>            
</div>