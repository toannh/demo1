...
<div class="col-sm-6 col-sm-push-6 features-text">
  ...
  <ul class="feature-list">
      ...
      <li>
        <div class="media">
            <a class="pull-left" href="#"><img class="img-circle" src="${baseUrl}/static/intro/img/support-Huong.jpg" style="width:60px;"></a>
            <div class="media-body">
                <h4 class="media-heading"><strong>Tăng Thị Hường</strong></h4>Tư vấn shop - Hà Nội<br>0167 463 6960
            </div>
        </div>
      </li>
      ...
      <li>
        <div class="media">
            <a class="pull-left" href="#"><img class="img-circle" src="${baseUrl}/static/intro/img/support-Huy.jpg" style="width:60px;"></a>
            <div class="media-body">
                <h4 class="media-heading"><strong>Lê Ngọc Huy</strong></h4>Tư vấn shop - Hà Nội<br>01666 233 343
            </div>
        </div>
      </li>
...
<div class="container">
	<div class="row">
		<div class="col-sm-6">
            ...
            <ul class="ul-ship">
                <li><a target="_blank" href="#" class="ems"></a></li>
                <li><a target="_blank" href="#" class="kerry"></a></li>
                <li><a target="_blank" href="#" class="nasco"></a></li>
                <li><a target="_blank" href="#" class="netco"></a></li>
                <li><a target="_blank" href="#" class="viettelpost"></a></li>
                <li><a target="_blank" href="#" class="vietnampost"></a></li>
                <li><a target="_blank" href="#" class="giaohangnhanh"></a></li>
                <li><a target="_blank" href="#" class="ghtk"></a></li>
            </ul>
		</div><!-- col -->
		<div class="col-sm-6">
            <div class="title">
  ...
  <div class="container logo">
	...
	<a href="http://chodientu.vn/user/open-shop-step1.html" target="_blank" class="w_btn">Click mở shop ngay</a>
        ...
        <div class="social_media">
            ...
            <a href="http://saobang.vn/" target="_blank"><img class="img-thumbnail" src="${baseUrl}/static/intro/img/lg-saobang.png" width="36" height="36"></a>
        </div>
