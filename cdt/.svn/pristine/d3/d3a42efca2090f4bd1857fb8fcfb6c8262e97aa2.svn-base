...
<div class="box-product bp-template1">
    <div class="bp-banner1">
        <% if(banner1==true){ %>
    ...
    <div class="bp-brand1">
        ...
        <div class="bb-item"><a href="javascript:;" onclick="urlUtils.manufacturerUrl('<%=this.categoryManufacturerHomes[i].manufacturerId%>');"><img src="<%=this.categoryManufacturerHomes[i].image%>" alt="logo"></a></div>
        <%}}%>
    </div>
    <div class="home-item bighome-item bp1">
        <% if(item1==true){ %>
        <div class="hoi-inner">
            ...
            <%}%>
            <a class="hoi-thumblink" href="<%= baseUrl %>/san-pham/<%= id1 %>/<%= textUtils.createAlias(name1) %>.html">
    ...
    <div class="home-item bighome-item bp2">
        <% if(item2==true){ %>
        <div class="hoi-inner">
            ...
            <%}%>
            <a class="hoi-thumblink" href="<%= baseUrl %>/san-pham/<%= id2 %>/<%= textUtils.createAlias(name2) %>.html">
                <img src="<%=image2%>" alt="product" />
            </a>

            <div class="hoi-title">
                <div class="hoi-row">
                    <a href="<%= baseUrl %>/san-pham/<%= id2 %>/<%= textUtils.createAlias(name2) %>.html"> <%=title2%></a>  
                </div>
                <div class="hoi-row">
    ...
    <div class="home-item bp3">
        ...
        <div class="hoi-inner">
            ...
            <%}%>
            <a class="hoi-thumblink" href="<%= baseUrl %>/san-pham/<%= id3 %>/<%= textUtils.createAlias(name3) %>.html">
                <img src="<%=image3%>" alt="product" />
            </a>

            <div class="hoi-title">
                <div class="hoi-row">
                    <a href="<%= baseUrl %>/san-pham/<%= id3 %>/<%= textUtils.createAlias(name3) %>.html"> <%=title3%></a>  
                </div>
                <div class="hoi-row">
    ...
    <div class="home-item bp4">
        ...
        <div class="hoi-inner">
            ...
            <%}%>
            <a class="hoi-thumblink" href="<%= baseUrl %>/san-pham/<%= id4 %>/<%= textUtils.createAlias(name4) %>.html">
                <img src="<%=image4%>" alt="product" />
            </a>
            <div class="hoi-title">
                <div class="hoi-row">
                    <a href="<%= baseUrl %>/san-pham/<%= id4 %>/<%= textUtils.createAlias(name4) %>.html"> <%=title4%></a>  
                </div>
                <div class="hoi-row">
    ...
    <div class="home-item bp5">
        ...
        <div class="hoi-inner">
            ...
            <%}%>
            <a class="hoi-thumblink" href="<%= baseUrl %>/san-pham/<%= id5 %>/<%= textUtils.createAlias(name5) %>.html">
                <img src="<%=image5%>" alt="product" />
            </a>

            <div class="hoi-title">
                <div class="hoi-row">
                    <a href="<%= baseUrl %>/san-pham/<%= id5 %>/<%= textUtils.createAlias(name5) %>.html"> <%=title5%></a>  
                </div>
                <div class="hoi-row">
    ...
    <div class="home-item bp6">
        <% if(item6==true){ %>
        <div class="hoi-inner">
            <% if(listingType6 == 'BUYNOW' && textUtils.percentFormat(startPrice6,sellPrice6,discount6,discountPrice6,discountPercent6)>0){ 
                %>                
                 <span class="hoi-sale">-<%=textUtils.percentFormat(startPrice6,sellPrice6,discount6,discountPrice6,discountPercent6)%>%</span>
            <%}%>
            <a class="hoi-thumblink" href="<%= baseUrl %>/san-pham/<%= id6 %>/<%= textUtils.createAlias(name6) %>.html">
                <img src="<%=image6%>" alt="product" />
            </a>

            <div class="hoi-title">
                <div class="hoi-row">
                    <a href="<%= baseUrl %>/san-pham/<%= id6 %>/<%= textUtils.createAlias(name6) %>.html"> <%=title6%></a>  
                </div>
                <div class="hoi-row">
                   
                     <% if(listingType6 == 'BUYNOW'){ %>
                        <span class="hoi-price"><%=textUtils.sellPrice(sellPrice6,discount6,discountPrice6,discountPercent6)%><sup class="u-price">đ</sup></span>
                        <% if(textUtils.discountPrice(startPrice6,sellPrice6,discount6,discountPrice6,discountPercent6) != 0) {  %>
                            <span class="hoi-oldprice"><%=textUtils.startPrice(startPrice6,sellPrice6,discount6)%><sup class="u-price">đ</sup></span>
                        <%}%>
                    <%}%>
                </div>
            </div>
            ...
            <div class="hoi-view">
                <a class="hoi-btn" href="javascript:;" onclick="market.quickview('<%=id6%>')">Xem nhanh</a>
                <a class="hoi-btn" href="#"><span class="icon24-star"></span></a>
            </div>
        </div>
        <%}%>
    </div><!-- home-item -->
    <div class="home-item bp7">
        <% if(item7==true){ %>
        <div class="hoi-inner">
            <% if(listingType7 == 'BUYNOW' && textUtils.percentFormat(startPrice7,sellPrice7,discount7,discountPrice7,discountPercent7)>0){ 
                %>                
                 <span class="hoi-sale">-<%=textUtils.percentFormat(startPrice7,sellPrice7,discount7,discountPrice7,discountPercent7)%>%</span>
            <%}%>
            <a class="hoi-thumblink" href="<%= baseUrl %>/san-pham/<%= id7 %>/<%= textUtils.createAlias(name7) %>.html">
                <img src="<%=image7%>" alt="product" />
            </a>

            <div class="hoi-title">
                <div class="hoi-row">
                    <a href="<%= baseUrl %>/san-pham/<%= id7 %>/<%= textUtils.createAlias(name7) %>.html"> <%=title7%></a>  
                </div>
                <div class="hoi-row">
                   
                     <% if(listingType7 == 'BUYNOW'){ %>
                        <span class="hoi-price"><%=textUtils.sellPrice(sellPrice7,discount7,discountPrice7,discountPercent7)%><sup class="u-price">đ</sup></span>
                        <% if(textUtils.discountPrice(startPrice7,sellPrice7,discount7,discountPrice7,discountPercent7) != 0) {  %>
                            <span class="hoi-oldprice"><%=textUtils.startPrice(startPrice7,sellPrice7,discount7)%><sup class="u-price">đ</sup></span>
                        <%}%>
                    <%}%>
                </div>
            </div>
            ...
            <div class="hoi-view">
                <a class="hoi-btn" href="javascript:;" onclick="market.quickview('<%=id7%>')">Xem nhanh</a>
                <a class="hoi-btn" href="#"><span class="icon24-star"></span></a>
            </div>
        </div>
        <%}%>
    </div><!-- home-item -->
    <div class="home-item bp8 zindex-bid">
        <% if(item8==true){ %>
        <div class="hoi-inner">
            <% if(listingType8 == 'BUYNOW' && textUtils.percentFormat(startPrice8,sellPrice8,discount8,discountPrice8,discountPercent8)>0){ 
                %>                
                 <span class="hoi-sale">-<%=textUtils.percentFormat(startPrice8,sellPrice8,discount8,discountPrice8,discountPercent8)%>%</span>
            <%}%>
            <a class="hoi-thumblink" href="<%= baseUrl %>/san-pham/<%= id8 %>/<%= textUtils.createAlias(name8) %>.html">
                <img src="<%=image8%>" alt="product" />
            </a>

            <div class="hoi-title">
                <div class="hoi-row">
                    <a href="<%= baseUrl %>/san-pham/<%= id8 %>/<%= textUtils.createAlias(name8) %>.html"> <%=title8%></a>  
                </div>
                <div class="hoi-row">
                   
                     <% if(listingType8 == 'BUYNOW'){ %>
                        <span class="hoi-price"><%=textUtils.sellPrice(sellPrice8,discount8,discountPrice8,discountPercent8)%><sup class="u-price">đ</sup></span>
                        <% if(textUtils.discountPrice(startPrice8,sellPrice8,discount8,discountPrice8,discountPercent8) != 0) {  %>
                            <span class="hoi-oldprice"><%=textUtils.startPrice(startPrice8,sellPrice8,discount8)%><sup class="u-price">đ</sup></span>
                        <%}%>
                    <%}%>
                </div>
            </div>
            ...
            <div class="hoi-view">
                <a class="hoi-btn" href="javascript:;" onclick="market.quickview('<%=id8%>')">Xem nhanh</a>
                <a class="hoi-btn" href="#"><span class="icon24-star"></span></a>
            </div>
        </div>
        <%}%>
