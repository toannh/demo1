...
<c:forEach items="${featuredcategory.categorySubs}" var="categorySubItem">
    <div class="box box-orange ipad-hidden">
        <div class="box-title">
            ...
            <div class="box-product bp-template1">
                <div class="bp-banner1">
                    <c:forEach items="${categorySubItem.categoryBannerHomes}" var="banner">
                        <c:if test="${banner.position==1}">
                            <a href="${banner.url}"><img src="${banner.image}" alt="banner"></a>
                            </c:if>
                        </c:forEach>
                </div>
                <div class="bp-brand1">
                    <c:forEach items="${categorySubItem.categoryManufacturerHomes}" var="logo">
                        <div class="bb-item"><a href="${baseUrl}${url:manufacturerUrl(logo.manufacturerId)}"><img src="${logo.image}" alt="logo"></a></div>
                            </c:forEach>
                </div>
                <c:forEach items="${categorySubItem.categoryItemHomes}" var="categoryItemHome">
                    <c:forEach items="${featuredcategory.items}" var="item">
                        ...
                        <c:if test="${categoryItemHome.position==6}">
                            <c:if test="${item.id==categoryItemHome.itemId}">
                        ...
                        <c:if test="${categoryItemHome.position==7}">
                            <c:if test="${item.id==categoryItemHome.itemId}">
                        ...
                        <c:if test="${categoryItemHome.position==8}">
                            <c:if test="${item.id==categoryItemHome.itemId}">
                                <div class="home-item bp8">
                                    <div class="hoi-inner">
                                        <c:if test="${item.listingType=='AUCTION'}">
                                        <span class="hoi-bid"></span>
                                        </c:if>
