            ...
            <div class="row list-table-content">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="pages-config-policy clearfix">    		                               	
                            ...
                            <div class="row mgt-15">
                                ...
                                <c:if test="${nlEmail != null && nlStatus}">
                                    <div class="col-lg-4 col-md-5 col-xs-12">
                                        ...
                                        <p class="text-right" id="nl-unlinked"><a style="cursor: pointer">Huỷ liên kết</a></p>
                                    </div>   
                                </c:if>
                                <c:if test="${!nlStatus || nlEmail == null}">
                                    <div class="col-lg-4 col-md-5 col-xs-12">
                                        ...
                                        <a href="https://www.nganluong.vn/?portal=nganluong&page=user_register">Đăng ký</a> nếu chưa có tài khoản NgânLượng
                                    </div>
                                </c:if>
                            </div>
                            ...
                            <div class="row mgt-15">
                                ...
                                <div class="col-lg-4 col-md-5 col-xs-12">
                                    <c:if test="${scEmail != null && scStatus}">
                                        ...
                                        <p class="text-right" id="sc-unlinked"><a style="cursor: pointer">Huỷ liên kết</a></p>
                                    </c:if>
                                    <c:if test="${!scStatus || scEmail == null}">
                                        <a id="sc-integration" class="btn btn-default btn-sm btn-block"><span class="icon-no-sc"></span> Liên kết tài khoản ShipChung</a>
                                        <a href="https://www.nganluong.vn/?portal=nganluong&page=user_register">Đăng ký</a> nếu chưa có tài khoản ShipChung
                                    </c:if>
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <form class="form-horizontal onlinePaymentBox" id="form-add-sellersupportfee">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4 col-xs-3"><sup class="u-price">đ</sup></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-3 col-xs-12">Mức giảm giá</label>
                                                <div class="col-sm-5 col-xs-9 discountType"><input type="text" class="form-control" name="discountPercent"></div>
                                                <div class="col-sm-4 col-xs-3">
                                                    <select class="form-control" id="discountPercent">
                        ...
                        <div class="box-step border-config-payment mgt-15"> 
                            <div class="title-config-shop">2.Chính sách phí vận chuyển mặc định</div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-xs-12">
                                    ...
                                    <div class="clearfix">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="radio">
                                                    <label><input type="radio" name="shipmentType" value="BYWEIGHT" <c:if test="${seller.shipmentType == 'BYWEIGHT'}" >checked="check"</c:if>> Phí vận chuyển linh hoạt theo địa chỉ người mua và cân nặng sản phẩm (theo bảng phí ChợĐiệnTử)</label>
                                            </div>
                                        </div>                                                    
                                    </div>
                                </div>                                            
                            ...
                            -->
                            <button class="btn btn-success" style="vertical-align:middle;margin-left: 15px" onclick="payment.saveShipmentConfig(true);">Cập nhật sản phẩm</button> 
