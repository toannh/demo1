<form class="form-horizontal" id="form-edit-shopcategory">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input name="weight" type="text"class="form-control" value="<%= (typeof(data) != 'undefined')? data.weight:'' %>"/>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-sm-3">Nổi bật trang chủ:</label>
        <div class="col-sm-8">
            <% if(data.home){ %>
            <input value="1" name="home" type="checkbox" checked="check"> 
            <% }else{ %>
            <input value="1" name="home" type="checkbox">
            <% } %>
        </div>
    </div>
</form>