                ...
                <div class="tab-container" id="viewModel">
                    <div id="home3tab1" class="tab-content" style="display: block;">
                        ...
                        <div class="home3-product">
                            <div class="hp-thumb"><a href="<%=baseUrl%><%=urlUtils.model(this.models[i].id,'this.models[i].name')%>"><img src="<%=this.models[i].images[0]%>" alt="<%=this.models[i].name%>"></a></div>
                            ...
                            <div class="hp-row">Hiện có: <a href="<%=urlUtils.browseUrl(market.itemSearch,'this.models[i].name',[{key:"cid",op:"rm"},{op: "mk", key: "models", val:this.models[i].id}])%>"><%=this.models[i].countShop%> cửa hàng đang bán</a></div>
                        </div>
                        <%}}%>
