...
public class TopUpClient {
    ...
    private final String affiliateCode = "b3e6f0cdeae384bbcf51bed7d90b6b8e";
    private final String partnerKey = "TTOLTEST";
    private final String encryptKey = "dbb6993e8555b19a822512b";
    private final String url = "http://thanhtoanonline.vn/topupTelcoPostTest.php";
